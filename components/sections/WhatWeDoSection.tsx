...
export default function WhatWeDoSection() {
  ...
  return (
    <section id="what-we-do" className="py-16 md:py-24 bg-gray-900 relative" ref={ref}>
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-black border-t border-b border-gray-800 p-6 text-center hover:border-gray-600 transition-all duration-300"
              >
                <div className="inline-flex items-center justify-center w-14 h-14 mb-4 bg-gray-800 rounded-full shadow-md">
